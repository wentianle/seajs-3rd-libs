 ...
 * ========================================================== */
define("ucloud/bootstrap/2.0.0/bootstrap-debug", [ "ucloud/jquery/1.8.2/jquery-debug" ], function(require, exports, module) {
 ...
 * ========================================================== */
  ...
  * ======================= */
    Bootstrap.alert = function(selector, option) {
 ...
 * ============================================================ */
  ...
  * ======================== */
    Bootstrap.button = function(selector, option) {
        return $(selector).each(function() {
 ...
 * ========================================================== */
  ...
  * ========================= */
    var Carousel = function(element, options) {
        this.$element = $(element);
        this.options = $.extend({}, Bootstrap.carousel.defaults, options);
  ...
  * ========================== */
    Bootstrap.carousel = function(selector, option) {
        return $(selector).each(function() {
 ...
 * ============================================================ */
    ...
    var Collapse = function(element, options) {
        this.$element = $(element);
        this.options = $.extend({}, Bootstrap.collapse.defaults, options);
  ...
  * ============================== */
    Bootstrap.collapse = function(selector, option) {
        return $(selector).each(function() {
 ...
 * ============================================================ */
  ...
  * ========================= */
   ...
   * ========================== */
    Bootstrap.dropdown = function(selector, option) {
        return $(selector).each(function() {
 ...
 * ========================================================= */
  ...
  * ====================== */
    var Modal = function(content, options) {
        this.options = $.extend({}, Bootstrap.modal.defaults, options);
  ...
  * ======================= */
    Bootstrap.modal = function(selector, option) {
        return $(selector).each(function() {
 ...
 * ========================================================== */
  ...
  * =============================== */
    ...
    Tooltip.prototype = {
        ...
        getOptions: function(options) {
            options = $.extend({}, Bootstrap[this.type].defaults, options, this.$element.data());
  ...
  * ========================= */
    Bootstrap.tooltip = function(selector, option) {
        return $(selector).each(function() {
 ...
 * =========================================================== */
    ...
    /* NOTE: POPOVER EXTENDS BOOTSTRAP-TOOLTIP.js
     ========================================== */
    Popover.prototype = $.extend({}, Bootstrap.tooltip.Constructor.prototype, {
        constructor: Popover,
        setContent: function() {
  ...
  * ======================= */
    Bootstrap.popover = function(selector, option) {
        return $(selector).each(function() {
    ...
    Bootstrap.popover.defaults = $.extend({}, Bootstrap.tooltip.defaults, {
        placement: "right",
        content: "",
 ...
 * ============================================================== */
   ...
   * ========================== */
    function ScrollSpy(element, options) {
        ...
        this.options = $.extend({}, Bootstrap.scrollspy.defaults, options);
  ...
  * =========================== */
    Bootstrap.scrollspy = function(selector, option) {
        return $(selector).each(function() {
 ...
 * ======================================================== */
  ...
  * ===================== */
    Bootstrap.tab = function(selector, option) {
        return $(selector).each(function() {
 ...
 * ============================================================ */
    ...
    var Typeahead = function(element, options) {
        this.$element = $(element);
        this.options = $.extend({}, Bootstrap.typeahead.defaults, options);
   ...
   * =========================== */
    Bootstrap.typeahead = function(selector, option) {
        return $(selector).each(function() {
    ...
    Bootstrap.typeahead.defaults = {
        source: [],
        items: 8,
        menu: '<ul class="typeahead dropdown-menu"></ul>',
        item: '<li><a href="#"></a></li>'
    };
    Bootstrap.typeahead.Constructor = Typeahead;
    /* TYPEAHEAD DATA-API
  * ================== */
    $(function() {
